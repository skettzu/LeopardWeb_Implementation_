...
void User::searchByParameter(sqlite3* DB, string user_parameter) {
	...
	string search_parameter = ("SELECT * FROM COURSES WHERE CRN = " + user_parameter + " OR starttime = " + user_parameter + " OR year = " + user_parameter + " OR credits = " + user_parameter + " OR duration = "+ user_parameter +" OR sections = "+ user_parameter +" OR endtime = " + user_parameter + ";");
